...
class Profiles:
    ...
    def price_profile(self, city, country, days):
    ...
    def pv_profile(self, city, country, days = 365):
        ...
        if lat is not None and lon is not None:
            ...
            logger.debug("PV data size: "+ str(len(pv_list)))
            logger.debug("PV data: ",pv_list)
            return pv_list

    def load_profile(self, type= "commercial", randint=0,  days=0):
...
if __name__ == "__main__":
    ...
    prof.pv_profile("bolzano", "italy", days=365)
    prof.load_profile(type="commercial", randint=0, days=365)
