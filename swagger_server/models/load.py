...
class Load(Model):
    ...
    def __init__(self, id: str=None, bus: str=None, phases: int=None, connection_type: str=None, power_profile_id: str=None, model: int=None, k_v: float=None, k_w: float=None, k_var: float=None):  # noqa: E501
